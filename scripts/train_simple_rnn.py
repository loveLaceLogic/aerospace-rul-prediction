...
from src.model import SimpleRNNRegressor
...
def main():
    ...
    device = get_device()
    model = SimpleRNNRegressor(input_size=len(FEATURE_COLS)).to(device)
    ...
    model_path = models_dir / "simple_rnn_fd001.pt"
    scaler_path = models_dir / "simple_rnn_scaler_fd001.joblib"
    meta_path = models_dir / "simple_rnn_meta_fd001.json"
